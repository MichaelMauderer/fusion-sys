 ...
 * @return Radians.
 */
float FusionDegreesToRadians(const float degrees) {
 ...
 * @return Degrees.
 */
float FusionRadiansToDegrees(const float radians) {
 ...
 */
float FusionVectorNormSquared(const FusionVector3 vector) {
 ...
 */
float FusionVectorMagnitude(const FusionVector3 vector) {
 ...
 * @return Normalised vector.
 */
FusionVector3 FusionVectorNormalise(const FusionVector3 vector) {
 ...
 * @return Normalised vector.
 */
FusionVector3 FusionVectorFastNormalise(const FusionVector3 vector) {
 ...
 */
FusionQuaternion FusionQuaternionMultiply(const FusionQuaternion quaternionA, const FusionQuaternion quaternionB) {
 ...
 */
FusionQuaternion FusionQuaternionNormalise(const FusionQuaternion quaternion) {
 ...
 */
FusionRotationMatrix FusionRotationMatrixMultiply(const FusionRotationMatrix rotationMatrixA, const FusionRotationMatrix rotationMatrixB) {
 ...
 */
FusionRotationMatrix FusionQuaternionToRotationMatrix(const FusionQuaternion quaternion) {
#define Q quaternion.element // define shorthand label for more readable code
